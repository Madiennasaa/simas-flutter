...
class HeadmasterAnnouncementsView extends StatefulWidget {
  const HeadmasterAnnouncementsView({super.key});

  @override
  State<HeadmasterAnnouncementsView> createState() =>
      _HeadmasterAnnouncementsViewState();
}

class _HeadmasterAnnouncementsViewState
    extends State<HeadmasterAnnouncementsView> {
  @override
  void initState() {
    super.initState();
